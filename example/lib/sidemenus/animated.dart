...
class AnimatedClipperSidemenu extends StatelessWidget {
  const AnimatedClipperSidemenu({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("AnimatedClipperSidemenu"),
        centerTitle: true,
      ),
      body: Row(
        mainAxisAlignment: MainAxisAlignment.start,
        children: [
          AnimatedSingleLevelSidemenu<BaseSidemenuData>(
